package com.yisan.addressdemo.utils;
...
public class PinyinUtil {
    ...
    public static String getHeadByHanzi(String hanzi){
        return getHeadByHanzi(hanzi,true);
    }

    public static String getHeadByHanzi(String hanzi, boolean toUpCase) {
